...
| FFmpeg | 3.4.14, source archive SHA-256 `61e255e824341e62fbc83365d84eb754fa558f53985d28ad610d13aeee895d5a`; ARMV4I archive SHA-256 `9a0615f9ceee423145a3495466511197af6385f61db92e8a212f80b117069797` | `third_party/ffmpeg-3.4.14/` | Upstream LGPLv2.1-or-later/GPLv2-or-later depending on the selected source files; retain `LICENSE.md`, `COPYING.*`, `POSITRON_PORT.md` and `positron_patches/`. The WM6 media DLL does not enable nonfree components or FFmpeg encoders. Optional archive regeneration uses the Apache-2.0 `c99-to-c89` 1.0.3 tool, whose package hash is recorded in `POSITRON_PORT.md`; it is a build prerequisite, not a product dependency. |
