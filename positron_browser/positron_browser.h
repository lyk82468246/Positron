 ...
 * and fieldset form-associated elements in document order, including
 * explicitly associated elements outside the form. Fieldsets are included
 * for the Browser form.elements collection but remain outside Core's
