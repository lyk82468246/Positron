...
document、DOM、navigation、event、input、keyboard、focus、EDIT change 和 SELECT input/change 适配。
...
- `PBrowser_ScriptSession*`：创建/销毁 PScript context、求值、JSON global、bootstrap、
  ...
  Event JSON 和 native input/keyboard/focus/EDIT change/SELECT input/change typed dispatch；
