...
document、DOM、navigation、event、input、keyboard、focus、EDIT change/post-change input、click、submit/reset、invalid 和 SELECT input/change 适配。
...
- `PBrowser_ScriptSession*`：创建/销毁 PScript context、求值、JSON global、bootstrap、
  ...
  Event JSON 和 native input/keyboard/focus/EDIT change/post-change input/click/submit/reset/invalid/SELECT input/change typed dispatch；
