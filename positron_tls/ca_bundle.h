 ...
 * The full Mozilla CA trust store (curl's cacert.pem),
 * one C string literal per root, so positron_tls can
 * verify arbitrary public HTTPS sites.
 *
 * DO NOT EDIT BY HAND. Regenerate with gen_ca_bundle.py.
 */

#ifndef POSITRON_CA_BUNDLE_H
#define POSITRON_CA_BUNDLE_H

/* One NUL-terminated PEM string per trusted root. */
static const char *g_ca_certs[] = {
...
static const int g_ca_cert_count =
    (int)(sizeof(g_ca_certs) / sizeof(g_ca_certs[0]));
