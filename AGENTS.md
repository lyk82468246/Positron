...
动态项目状态维护在 `.agents/`，历史材料进入 `docs/history/` 或 Git 历史。
...
2. 至少核对 `docs/ARCHITECTURE.md`、`.agents/HANDOFF.md`、
...
- 设备日志通过前不得把候选写成正式基线。通过后按职责更新 handoff、限制和路线图；只有
  稳定且面向读者的能力变化才更新 README/`docs/`。只提交本批 tracked 文件并推送当前分支。
