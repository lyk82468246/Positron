...
static const AppTextResourcePair g_text_resources[APP_TEXT_COUNT] = {
    ...
    { IDS_STATUS_FORM_INVALID_EN, IDS_STATUS_FORM_INVALID_ZH },
    { IDS_STATUS_FORM_UNSUPPORTED_EN, IDS_STATUS_FORM_UNSUPPORTED_ZH },
    { IDS_STATUS_FORM_FAILED_EN, IDS_STATUS_FORM_FAILED_ZH },
    { IDS_STATUS_FILE_FAILED_EN, IDS_STATUS_FILE_FAILED_ZH },
    { IDS_FILE_PICKER_TITLE_EN, IDS_FILE_PICKER_TITLE_ZH },
