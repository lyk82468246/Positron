...
#define FFMPEG_CONFIGURATION "--enable-cross-compile --disable-everything --disable-programs --disable-doc --disable-network --disable-encoders --disable-filters --disable-indevs --disable-outdevs --disable-hwaccels --disable-muxers --disable-bsfs --disable-parsers --disable-demuxers --disable-xlib --disable-zlib --enable-avcodec --enable-avformat --enable-avutil --enable-protocol=file --enable-demuxer='avi,matroska,mov,mpegps,mpegts,wav,flv,amr,mp3,aac' --enable-parser='h264,aac,mpeg4video,mpegvideo,mjpeg,h263,mpegaudio' --enable-decoder='h264,mpeg4,mpeg1video,mpeg2video,mjpeg,h263,aac,mp2,mp3,amrnb,amrwb,pcm_s16le,pcm_s8,pcm_u8,pcm_u16le,adpcm_ima_wav' --enable-small --disable-debug --disable-pthreads --disable-w32threads --disable-os2threads --disable-runtime-cpudetect --disable-asm --disable-yasm --arch=arm --cpu=armv4 --target-os=win32 --cc=armclwrap.bat --cxx=armclwrap.bat --ld=armlinkwrap.bat --ar=armlibwrap.bat"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2025
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Microsoft (R) ARM C/C++ Optimizing Compiler Version 15.00.21022.08 for Windows CE ARM"
