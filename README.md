...
| **5** | `positron_image.dll` — 可复用图片基础设施 | 🚧 BMP/PNG/JPEG/GIF 仍由 WM Imaging；Expat 2.8.2 + libdom XML + libsvgtiny 的内存 SVG 解析已由 TEST 25 真机验证；SVG 绘制待补 |
