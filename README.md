...
- **GDI Render**：TEST 12、14、17、19、20、26-37、39、46-58、62-64，覆盖 WM Imaging、SVG path/cache/fallback/fill-rule、CSS background-image、原生 GDI text、线性/径向渐变、继承/透明 stop、同文档及重叠文档缓存复用、IANA token 间距、table span/匿名归一化/collapsed border/cell alignment/height distribution、列表 marker/counter/image/inside flow、HTML inline author CSS、checkbox/radio 静态 redraw 与基础交互、随包字体 fallback，离线；TEST48-58、62-64 已验收。
