...
| `positron_browser.dll` | history/session、脚本 bootstrap、DOM/Event、候选导航生命周期与结果摘要、平台回调协调 | `PBrowser_HistoryCreate`、`PBrowser_ScriptSessionCreate`、`PBrowser_NavigationCandidateCreate`、`PBrowser_NavigationCandidateGetResult` |
