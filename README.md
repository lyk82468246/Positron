...
| **5** | `positron_image.dll` — 可复用图片基础设施 | 🚧 retained 解码、SVG、独立消费及 PNG/JPEG 内存编码均已真机闭环；libjpeg-turbo 4:4:4 JPEG 后端待 next49 确认 |
