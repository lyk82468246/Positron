...
- **GDI Render**：TEST 12、14、17、19、20、26-37、39、46，覆盖 WM Imaging、SVG path/cache/fallback/fill-rule、CSS background-image、原生 GDI text、线性/径向渐变、继承/透明 stop、缓存复用、IANA token 间距与 table span 正式 redraw，离线；TEST26-39 已真机通过，TEST46 待本批真机确认。
