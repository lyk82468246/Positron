...
**next155 候选（设备待验收，2026-08-08）**：在 next154 的 system-key 桥上补齐单个
BMP `WM_CHAR` 的 UTF-16→UTF-8 事件数据；显式脚本 context 中，EDIT/SELECT 可接收
...
C89、仓库审计和 VS2008 ARMV4I Debug 增量构建已通过，设备包待运行，预计位于
`C:\WMShare\Positron-next155`。
