...
- **GDI Render**：TEST 12、14、17、19、20、26-37、39、46-54，覆盖 WM Imaging、SVG path/cache/fallback/fill-rule、CSS background-image、原生 GDI text、线性/径向渐变、继承/透明 stop、缓存复用、IANA token 间距、table span/匿名归一化/collapsed border、列表 marker/counter/image/inside flow 与随包字体 fallback 正式 redraw，离线；TEST48-53 已验收，TEST54/next65 待设备验收。
