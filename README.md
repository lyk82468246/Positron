...
| **5** | `positron_image.dll` — 可复用图片基础设施 | 🚧 retained 解码、SVG、PNG/JPEG 与原始像素入口均已真机闭环；ABI 1.4 原生 BMP/GIF 编码已由 next51 真机闭环，原生标题栏 OK 真退出待 next52 验收 |
