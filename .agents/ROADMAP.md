...
1. 以 next121 / TEST80-83 加 next114 Browse 门禁作为当前已验证自动化基线，后续每批继续以 TEST13 深层导航和旋转作为浏览器门禁。
