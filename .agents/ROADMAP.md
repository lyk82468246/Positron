...
当前自动化设备基线为 next198：`screen=240x240 dpi=96` 默认日志中 TEST13 三段导航及
TEST20/27/43/44/56/58-77/80-166 全部通过，配置所选 113 项全部 OK、零 ERROR、零 FAIL，并记录
...
1. 以 next198 的 TEST13/20/27/43/44/56/58-77/80-166 设备日志作为已验证自动化基线；
   后续每批继续以 TEST13 深层导航、动态 DPI 和定期旋转/真实点击作为浏览器门禁。
2. next198 的 TEST166 设备门已通过并升级基线；后续浏览器 JavaScript 绑定仍按一个纵切一个
   设备门推进。
