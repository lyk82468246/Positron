...
当前自动化设备基线为 next190：`screen=240x240 dpi=96` 默认日志中 TEST13 三段导航及
TEST20/27/43/44/56/58-77/80-158 全部通过，配置所选 105 项全部 OK、零 ERROR、零 FAIL，并记录
...
1. 以 next190 的 TEST13/20/27/43/44/56/58-77/80-158 设备日志作为已验证自动化基线；
