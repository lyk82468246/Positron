...
next295 将补齐 programmatic file-input click 的宿主 deferred picker request，限定在可用
render window、click 未取消和单次排队，不把系统 picker 或窗口生命周期移入产品 DLL。
