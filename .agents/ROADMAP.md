...
CharacterData 同父/跨父替换。Core 按 source/target 未过滤索引提交，旧 Ex10 及更早 ABI
布局不变。DocumentFragment、通用 CharacterData 替换/删除、mutation 事件、observer 和 live collection 仍需由真实页面
缺口驱动，不能从窄路径外推。
