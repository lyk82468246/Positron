...
- 最新已验证产品基线：next338（最近一次累计检查点仍为 next326；最近一次完整自动基线仍为 next255）。
...
- TEST305/999、C89、审计和正式构建均保持通过；下一次启用 JavaScript 的相关回归继续采用
  `68–73/189–231/233–262/264–305/999` 定向选择；next299 的
