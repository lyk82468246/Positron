...
**当前自动化设备基线（next196，2026-08-12）**：`screen=240x240 dpi=96` 自动日志完成
TEST13/20/27/43/44/56/58-77/80-164，配置所选 111 项全部 OK、零 ERROR、零 FAIL、最终
TESTBENCH PASS；TEST13 使用 `OK (overview)`，其余 110 项使用标准数字 OK 行。
