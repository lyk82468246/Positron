...
**当前自动化设备基线（next201，2026-08-12）**：`screen=640x480 dpi=192` 自动日志完成
TEST13/20/27/43/44/56/58-77/80-169，配置所选 116 项全部 OK、零 ERROR、零 FAIL、最终
TESTBENCH PASS；TEST13 使用 `OK (overview)`，其余 115 项使用标准数字 OK 行。
