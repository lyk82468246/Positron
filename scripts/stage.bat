...
REM the nine runtime binaries and optional test selection file we need. Optional arg 2
...
echo and run positron.exe for the standalone browser app, or test_host.exe
echo for the regression harness, from the shared-folder equivalent of %STAGE%.
echo.
exit /b 0
